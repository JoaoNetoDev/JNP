    ...
    public static function init($layoutName)
    {
        ...
        if ( TSession::getValue('logged') )
        {
            if (isset($_REQUEST['template']) AND $_REQUEST['template'] == 'iframe')
            {
                ...
                $content = file_get_contents("app/resources/layoutNoMenu.html");
            }
            else
            {
...
// var_dump(BuilderTemplateParser::init('layout'));

$content = myTemParser::init('layout');
...
if ($class)
{
    ...
    JNP::jnp_load_page($class, $method, $_REQUEST);
}
